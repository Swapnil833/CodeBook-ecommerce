  ...
  useEffect(() => {
    async function fetchProducts(){
      ...
      setProduct(data);
        ...
        toast.error(error.message, {position: "bottom-center" ,closeButton: true});
      }
    }
    fetchProducts();
  }, [id]);
          ...
          <div className="flex flex-wrap justify-around">
            ...
            <div className="max-w-xl my-3">
              ...
              <p className="my-3">
                ...
                { inCart && <button onClick={() => addToCart(product)} className={`inline-flex items-center py-2 px-5 text-lg font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 ${product.in_stock ? "" : "cursor-not-allowed"}`} disabled={ product.in_stock ? "" : "disabled" }> Remove Item <i className="ml-1 bi bi-trash3"></i></button>}
              </p>
